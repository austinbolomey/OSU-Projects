    ...
    public static void main(String[] args) {
        ...
        if (state) {
            ...
            if (xml.isTag()) {
                ...
                outputHeader(channel, outputHTML);

                for (int i = 0; i < channel.numberOfChildren(); i++) {
                    if (channel.child(i).label().equals("item")) {
                        processItem(channel.child(i), outputHTML);
                    }
                }
            }
            outputFooter(outputHTML);

        } else {
            out.println("No futher action was taken, program exiting now.");
        }
