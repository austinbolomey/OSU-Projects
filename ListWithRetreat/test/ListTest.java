...
public abstract class ListTest {
    ...
    @Test
    public final void testRetreatRightNotEmpty() {
        /*
         * Set up variables
         */
         ...
         * Evaluate the correctness of the result
         */
        assertEquals(list1.leftLength(), 0);
        //assertEquals(list2.leftLength(), 0);
        assertEquals(list2, list1);
    }
    ...
    @Test
    public final void testRetreatLeftMoreThanOne() {
        /*
         * Set up variables
         */
         ...
         * Evaluate the correctness of the result
         */
        assertEquals(list1.leftLength(), 1);
        assertEquals(list2, list1);
    }

    @Test
    public final void testRetreatUntilLeftEmptyLeftMoreThanOne() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "red", "green", "blue");
    ...
    @Test
    public final void testRetreatRighStartingEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "red", "green", "blue");
        ...
        //call retreat method once
        list1.retreat();

        /*
         * Evaluate the correctness of the result
         */
        assertEquals(list1.leftLength(), 2);
        assertEquals(list2, list1);
    }

    @Test
    public final void testRetreatRighStartingLeftEmpty() {
        /*
         * Set up variables
         */
