...
public final class Statement1Parse1 extends Statement1 {
    ...
    private static void parseIf(Queue<String> tokens, Statement s) {
        ...
        Reporter.assertElseFatalError(t.equals("THEN"), "Missing THEN.");
    ...
    private static void parseWhile(Queue<String> tokens, Statement s) {
        ...
        Reporter.assertElseFatalError(doState.equals("DO"),
                "Violation of: missing DO");
        body.parseBlock(tokens);
        tokens.dequeue();
        String endWhile = tokens.dequeue();
        Reporter.assertElseFatalError(endWhile.equals("WHILE"),
                "Violation of: WHILE and END WHILE must be in pairs");
    ...
    public void parseBlock(Queue<String> tokens) {
        ...
        while (front.equals("IF") || front.equals("WHILE")
            ...
            state.parse(tokens);
            this.addToBlock(this.lengthOfBlock(), state);
            front = tokens.front();
        }
        Reporter.assertElseFatalError(Tokenizer.isKeyword(front), "Invalid");
